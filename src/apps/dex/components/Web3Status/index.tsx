...
import { useHasSocks } from "apps/dex/hooks/useSocksBalance";
...
import Identicon from "apps/dex/components/Identicon";
import Loader from "apps/dex/components/Loader";

import { RowBetween } from "apps/dex/components/Row";
import WalletModal from "apps/dex/components/WalletModal";
  ...
  if (account) {
    return (
      ...
      >
        ...
        {!hasPendingTransactions && connector && <StatusIcon />}
      </Web3StatusConnected>
    );
  } else if (error) {
    return (
