...
} from "apps/dex/utils/wrappedCurrency";
...
import { Field, typeInput } from "apps/dex/state/mint/actions";
  ...
  const dependentAmount: CurrencyAmount | undefined = useMemo(() => {
    if (noLiquidity) {
      ...
      if (tokenA && tokenB && wrappedIndependentAmount && pair) {
        ...
        return dependentCurrency === XDC
          ? CurrencyAmount.xdc(dependentTokenAmount.raw)
