...
import { usePair } from "apps/dex/data/Reserves";
...
import { useTokenBalances } from "apps/dex/state/wallet/hooks";
import { Field, typeInput } from "apps/dex/state/burn/actions";
