...
export const hasCollateralReserve = (
  ...
  return (
    (txn as TransactionHistoryItem<ActionFields["LiquidationCall"]>)
      .collateralReserve !== undefined
  );
};
...
export const hasReserve = (
  ...
  | TransactionHistoryItem<ActionFields["UsageAsCollateral"]> => {
  return (
    (txn as TransactionHistoryItem<ActionFields["Supply"]>).reserve !==
    undefined
  );
};
...
export const hasAmountAndReserve = (
  ...
  | TransactionHistoryItem<ActionFields["RedeemUnderlying"]> => {
  return (
    (txn as TransactionHistoryItem<ActionFields["Supply"]>).amount !==
      undefined &&
    (txn as TransactionHistoryItem<ActionFields["Supply"]>).reserve !==
      undefined
  );
...
export const hasSwapBorrowRate = (
  txn: TransactionHistoryItemUnion
): txn is TransactionHistoryItem<ActionFields["SwapBorrowRate"]> => {
  return (
    (txn as TransactionHistoryItem<ActionFields["SwapBorrowRate"]>)
      .variableBorrowRate !== undefined &&
    (txn as TransactionHistoryItem<ActionFields["SwapBorrowRate"]>)
      .stableBorrowRate !== undefined
  );
};
