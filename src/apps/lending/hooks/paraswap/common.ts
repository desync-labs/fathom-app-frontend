...
/**
 * @notice This is the address of the fee claimer contract on the Ethereum network
 */
const PARASWAP_FEE_CLAIMER = "0x9abf798f5314BFd793A9E57A654BEd35af4A1D60";

const getFeeClaimerAddress = () => {
  return PARASWAP_FEE_CLAIMER;
};
...
const ExactInSwapper = (chainId: ChainId) => {
  ...
  const FEE_CLAIMER_ADDRESS = getFeeClaimerAddress();
