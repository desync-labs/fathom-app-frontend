...
export default function AnalyticsBanner() {
  ...
  const hasUserMadeChoice =
    ...
    localStorage.getItem("userAcceptedAnalytics") !== null;
    ...
    <>
      <AnalyticsConsentBanner
        ...
        declineButtonStyle={{
          ...
          // padding: '10px 20px',
          border: `1px solid ${
            theme.palette.mode === "dark" ? "#383D51" : "#EAEBEF"
          }`,
          width: "172px",
          height: "36px",
          // padding: '0px',
      ...
      >
        <Box>
          We may employ on-the-spot tracking techniques during your browsing
          session to collect data on your interactions, preferences, and
          behaviour. This data helps us personalise your experience and improve
