...
export const networkConfigs: Record<string, BaseNetworkConfig> = {
  [FathomLendingApothem.CHAIN_ID]: {
    ...
    isTestnet: true,
    networkLogoPath: "/icons/networks/apothem.png",
  ...
  [ChainId.avalanche]: {
    name: "Avalanche",
    privateJsonRPCUrl:
      "https://avax-mainnet.gateway.pokt.network/v1/lb/62b3314e123e6f00397f19ca",
    publicJsonRPCUrl: [
  ...
  [ChainId.base]: {
    name: "Base",
    privateJsonRPCUrl:
      "https://base-mainnet.gateway.pokt.network/v1/lb/62b3314e123e6f00397f19ca",
    publicJsonRPCUrl: [
