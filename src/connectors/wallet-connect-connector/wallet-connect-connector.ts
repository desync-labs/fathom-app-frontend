...
export class WalletConnectConnector extends AbstractConnector {
  ...
  public async activate(): Promise<ConnectorUpdate> {
    ...
    const account = await new Promise<string>((resolve, reject) => {
      ...
      (this.walletConnectProvider as EthereumProvider).on("disconnect", () => {
      ...
      (this.walletConnectProvider as EthereumProvider)
        .enable()
  ...
  public async getChainId(): Promise<number | string> {
    return Promise.resolve(
      (this.walletConnectProvider as EthereumProvider).chainId
    );
  }

  public async getAccount(): Promise<null | string> {
    return Promise.resolve(
      (this.walletConnectProvider as EthereumProvider).accounts
