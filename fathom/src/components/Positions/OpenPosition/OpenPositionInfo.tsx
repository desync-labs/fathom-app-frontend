      ...
      <AppList>
        ...
        >
          <ListItemText primary={
            <ListTitleWrapper>
              ...
              <AppPopover id={'collateral-locked'} text={'Collateral to be Locked - the amount of Collateral to be used to borrow FXD'} />
            </ListTitleWrapper>
          } />
        </AppListItem>
        <AppListItem
        ...
        >
          <ListItemText primary={
            <ListTitleWrapper>
              Safety Buffer
              <AppPopover id={'safety-buffer'} text={<>
        ...
        >
          <ListItemText primary={
            <ListTitleWrapper>
              ...
              <AppPopover id={'max-fxd-borrowed'} text={<>
                Max FXD can be Borrowed - how many FXD you can borrow providing Collateral with 0% Safety Buffer
              </>} />
            </ListTitleWrapper>
          } />
        </AppListItem>
          ...
          <ListItemText
            primary={
              <ListTitleWrapper>
                Stability Fee
                <AppPopover id={"liquidation-price"}
                            text={"Stability Fee - yearly interest paid when a position is closed. This fee is used to cover bad debt for liquidators, and any remaining part of the stability fee may be considered Fathom Protocol revenue."} />
              </ListTitleWrapper>
            }
          />
        </AppListItem>
