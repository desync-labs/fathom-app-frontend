...
const ProposeNotices: FC<ProposeNoticesProps> = ({ vBalance, minimumVBalance, vBalanceError }) => {
  if (vBalance !== null && BigNumber(vBalance).dividedBy(10 ** 18).isLessThan(minimumVBalance!)) {
    return vBalanceError ? (
      <ErrorBox sx={{ my: 3 }}>
        ...
        />
        <ErrorMessage>
          You have less than {formatNumber(minimumVBalance!)} vFTHM, and you
    ...
    return vBalanceError ? (
      <ErrorBox sx={{ my: 3 }}>
        ...
        />
        <ErrorMessage>
          To create a proposal, you need to have {formatNumber(minimumVBalance!)} vFTHM.<br />
