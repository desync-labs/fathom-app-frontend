...
import { InfoBox, Summary, WalletBalance } from "components/AppComponents/AppBox/AppBox";
...
const DepositVaultForm = ({ isMobile, onClose }: any) => {
            ...
            >
                ...
                <InfoBox sx={{ alignItems: "flex-start" }} >
                    ...
                    <Box flexDirection="column">
                        ...
                        <ButtonPrimary style={{ margin: "16px 0" }}>Approve Token</ButtonPrimary>
                    </Box>
                </InfoBox>
                <ButtonsWrapper>
                    {!isMobile && (
