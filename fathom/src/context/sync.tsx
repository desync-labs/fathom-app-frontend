...
export const SyncContext = createContext<UseSyncContextReturnType>(
  {} as UseSyncContextReturnType
);
...
const useSyncContext = (): UseSyncContextReturnType => {
