...
test.describe("Fathom App Test Suite: Lending - FXD Token Tests", () => {
  ...
  test(
    qase(53, "Supply FXD Token when no FXD is supplied is successful"),
    async ({ lendingPage }) => {
  ...
  test(
    qase(54, "Supply FXD Token when FXD is already supplied is successful"),
    async ({ lendingPage }) => {
      const assetName = LendingAssets.FXD;
  ...
  test(
    qase(55, "Borrow FXD Token with variable APY rate is successful"),
    async ({ lendingPage }) => {
      const assetName = LendingAssets.FXD;
  ...
  test(
    qase(56, "Borrow FXD Token with stable APY rate is successful"),
    async ({ lendingPage }) => {
  ...
  test(
    qase(
      57,
      "Toggling FXD token APY type to variable and stable is successful"
    ),
    async ({ lendingPage }) => {
      const assetNameOne = LendingAssets.FXD;
      const assetNameTwo = LendingAssets.CGO;
  ...
  test(
    qase(58, "Repay FXD with regular FXD partially is successfull @smoke"),
    async ({ lendingPage }) => {
      const assetName = LendingAssets.FXD;
      const supplyAmount = 10;
      const borrowAmount = 1;
  ...
  test(
    qase(59, "Repay FXD fully with fmFXD is successful"),
    async ({ lendingPage }) => {
      // Supply token first
      const assetName = LendingAssets.FXD;
      const supplyAmount = 10;
  ...
  test(
    qase(60, "Withdraw FXD partially is successful"),
    async ({ lendingPage }) => {
      // Supply token first
      const assetName = LendingAssets.FXD;
      const supplyAmount = 10;
  ...
  test(
    qase(61, "Withdraw FXD fully is successful @smoke"),
    async ({ lendingPage }) => {
      const assetName = LendingAssets.FXD;
      const supplyAmount = 10;
      // Supply token first
  ...
  test(
    qase(62, "Toggling FXD collateral to enabled / disabled is successful"),
    async ({ lendingPage }) => {
      const assetName = LendingAssets.FXD;
  ...
  test(
    qase(
      63,
      "Add fmFXD token to wallet from supply success modal is successful"
    ),
    async ({ lendingPage }) => {
      const assetName = LendingAssets.FXD;
      ...
      await expect(
        lendingPage.descriptionAddToWalletAllDoneModal
      ).toContainText(`fm${assetName}`);
  ...
  test(
    qase(64, "Add FXD token to wallet from borrow success modal is successful"),
    async ({ lendingPage }) => {
      const assetName = LendingAssets.FXD;
